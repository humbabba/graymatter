...
/* harmony export */   "renderInsertImageUi": () => (/* binding */ renderInsertImageUi),
/* harmony export */   "renderInsertLinkUi": () => (/* binding */ renderInsertLinkUi),
/* harmony export */   "renderTextColorUi": () => (/* binding */ renderTextColorUi),
/* harmony export */   "textEditorOnChangeCallback": () => (/* binding */ textEditorOnChangeCallback)
/* harmony export */ });
/* harmony import */ var _textEditor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./textEditor */ "./resources/js/components/textEditor.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal */ "./resources/js/components/modal.js");
/* harmony import */ var _saveFlag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./saveFlag */ "./resources/js/components/saveFlag.js");
/**
 * Imports
 */
...
var textEditorOnChangeCallback = function textEditorOnChangeCallback(form) {
  ...
  if (!modalMaster.length || 'none' === modalMaster.css('display')) {
    ...
    (0,_saveFlag__WEBPACK_IMPORTED_MODULE_2__.maybeShowSaveFlag)(form);
  }
};
/**
...
$(document).ready(function () {
  (0,_saveFlag__WEBPACK_IMPORTED_MODULE_2__.pickUpFlagSaverChanges)();
});
/**
...
var renderInsertLinkUi = function renderInsertLinkUi(editArea) {
  ...
  (0,_textEditor__WEBPACK_IMPORTED_MODULE_0__.insertOpenAndCloseMarkers)(range);
  var modalConfigs = {
  ...
  var modal = new _modal__WEBPACK_IMPORTED_MODULE_1__.CentaModal(modalConfigs, _textEditor__WEBPACK_IMPORTED_MODULE_0__.insertLinkViaUi);
  modal.render();
};
/**
...
var renderInsertImageUi = function renderInsertImageUi(editArea) {
  ...
  var modal = new _modal__WEBPACK_IMPORTED_MODULE_1__.CentaModal(modalConfigs, _textEditor__WEBPACK_IMPORTED_MODULE_0__.insertImageViaUi);
  modal.render();
};
/**
...
var renderTextColorUi = function renderTextColorUi(editArea) {
  ...
  var modal = new _modal__WEBPACK_IMPORTED_MODULE_1__.CentaModal(modalConfigs, _textEditor__WEBPACK_IMPORTED_MODULE_0__.insertTextColorViaUi);
  modal.render();
};
/**
...
__webpack_require__(/*! ./listSorter */ "./resources/js/components/listSorter.js");

__webpack_require__(/*! ./modal */ "./resources/js/components/modal.js");

__webpack_require__(/*! ./nav */ "./resources/js/components/nav.js");

__webpack_require__(/*! ./saveFlag */ "./resources/js/components/saveFlag.js");

__webpack_require__(/*! ./sorters */ "./resources/js/components/sorters.js");

__webpack_require__(/*! ./textEditor */ "./resources/js/components/textEditor.js");

/***/ }),

/***/ "./resources/js/components/listSorter.js":
/*!***********************************************!*\
  !*** ./resources/js/components/listSorter.js ***!
  \***********************************************/
/***/ (() => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CentaModal": () => (/* binding */ CentaModal)
/* harmony export */ });
/* harmony import */ var _textEditor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./textEditor */ "./resources/js/components/textEditor.js");
...
var finishModalRender = function finishModalRender(modalTemplate) {
  (0,_textEditor__WEBPACK_IMPORTED_MODULE_0__.initTextEditors)();
...
function addDropdownHandler(el) {
  ...
  addWindowHandlers(dropdownLinksUl); //Handle cliks on the main link to show or hide dropdown items
  ...
  mainLink.on('click', function (e) {
    ...
    var others = $('li.nav-links-dropdown').not(el);
...
/***/ "./resources/js/components/saveFlag.js":
/*!*********************************************!*\
  !*** ./resources/js/components/saveFlag.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "maybeShowSaveFlag": () => (/* binding */ maybeShowSaveFlag),
/* harmony export */   "pickUpFlagSaverChanges": () => (/* binding */ pickUpFlagSaverChanges)
/* harmony export */ });
/**
...
/***/ "./resources/js/components/sorters.js":
/*!********************************************!*\
  !*** ./resources/js/components/sorters.js ***!
  \********************************************/
/***/ (() => {
...
/***/ "./resources/js/components/textEditor.js":
/*!***********************************************!*\
  !*** ./resources/js/components/textEditor.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initTextEditors": () => (/* binding */ initTextEditors),
/* harmony export */   "insertImageViaUi": () => (/* binding */ insertImageViaUi),
/* harmony export */   "insertLinkViaUi": () => (/* binding */ insertLinkViaUi),
/* harmony export */   "insertOpenAndCloseMarkers": () => (/* binding */ insertOpenAndCloseMarkers),
/* harmony export */   "insertTextColorViaUi": () => (/* binding */ insertTextColorViaUi)
/* harmony export */ });
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modal */ "./resources/js/components/modal.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ "./resources/js/components/index.js");
...
var toolsArray = [{
  ...
  "class": 'fas fa-code toolbar-spacer',
  tool: 'toggleCode',
  ...
  "class": 'fas fa-unlink toolbar-spacer',
  tool: 'unlink',
  title: 'Unlink'
}, {
  ...
  "class": 'fas fa-outdent toolbar-spacer',
  tool: 'outdent',
  title: 'Outdent'
}, {
...
$(window).resize(function () {
  ...
  textEditors.each(function (index, el) {
    ...
    var hiddenInput = $(el).find('input[type="hidden"]').first(); //Reset hidden input in DOM instead of textEditor
...
var makeTextEditor = function makeTextEditor(el) {
      ...
      switch (item.tool) {
        case 'insertImage':
          if (editArea.is(':focus')) {
            (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.renderInsertImageUi)(editArea);
          }
        ...
        case 'createLink':
          if (editArea.is(':focus')) {
            (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.renderInsertLinkUi)(editArea);
          }
        ...
        case 'textColor':
          if (editArea.is(':focus')) {
            (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.renderTextColorUi)(editArea);
          }
        ...
        case 'clearFormat':
          if (editArea.is(':focus')) {
            ...
            var targetInput = copyDiv.next('.textEditor');
            var x = 0;
        ...
        case 'toggleCode':
          copyDiv = $(this).closest('.textEditorMasterDiv').find('.fancy-text-div').first();
          codeDiv = $(this).closest('.textEditorMasterDiv').find('.code-editor').first();
          var buttonsToToggle = $(this).closest('.textEditorMasterDiv').find('.toolbar-button').not('.fa-code');
          var selectorToToggle = $(this).closest('.textEditorMasterDiv').find('.tiny-selector');
  ...
  editor.append(editArea); //Start codeEditArea with a P element so the first line gets wrapped

  codeEditArea.val(paragraphize(el.val())); //Only check for changes in codeEditArea if we have a callback.

  if (_index_js__WEBPACK_IMPORTED_MODULE_1__.textEditorOnChangeCallback) {
    codeEditArea.on('keydown', function () {
      ...
      if (this.editAreaContent != this.newEditAreaContent) {
        ...
        (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.textEditorOnChangeCallback)(el.closest('form'));
      }
    });
...
var execFormattingTool = function execFormattingTool(tool, editArea) {
  ...
  range = insertOpenAndCloseMarkers(range); //This makes sure markers are *inside* top-level P tags
  ...
  var hiddenInput = masterDiv.find('.textEditor');
...
var getSelectionObject = function getSelectionObject(tool, editArea, emptySelection, props) {
  ...
  if (props) {
    var toolWithProps = '<' + tool;
    var keys = Object.keys(props);
    keys.forEach(function (key, index) {
      toolWithProps += " ".concat(key, "=\"").concat(props[key], "\"");
    });
    toolWithProps += '>';
  ...
  if (containsOpenTag || containsCloseTag || selectionObject.openAncestor || selectionObject.closeAncestor) {
    ...
    tools.each(function () {
      if (0 === $(this).find(tool).length) {
        //This allows us only to give this treatment to the bottom-most children
    ...
    if (contentStringObj.text() === wrappedText) {
      //So if placeholder sting equals the text of the overall object, then we know all text had already been wrapped in the tool.
...
var activateToolDisplay = function activateToolDisplay(editArea, tool) {
...
var inactivateToolDisplay = function inactivateToolDisplay(editArea, tool) {
  ...
  editArea.closest('.textEditorMasterDiv').find("[data-tool='".concat(tool, "']")).removeClass('active');
  var targetToolIndex = activeTools.indexOf(tool);
...
var inactivateNonSelectedToolsDisplay = function inactivateNonSelectedToolsDisplay(editArea) {
...
var getCleanContent = function getCleanContent(content) {
...
var cleanRedundantCode = function cleanRedundantCode(editArea) {
  ...
  tags.forEach(function (tag) {
    var openTag = '<' + tag + '>';
    var closeTag = '</' + tag + '>'; //Case: Tag closes and immediately opens again, with a marker between.
...
var paragraphize = function paragraphize(text) {
  if (text && '' !== text) {
    var openTagPattern = new RegExp('<div', 'gi');
    var closeTagPattern = new RegExp('</div>', 'gi');
...
var replaceMarkersWithSelection = function replaceMarkersWithSelection(editArea) {
  ...
  logVitals('replaceMarkersWithSelection'); //Make brand-new range
...
var stripTags = function stripTags(el) {
  if ('A' === el.tagName) {
...
var handleIndentation = function handleIndentation() {
  ...
  var editArea = arguments.length > 1 ? arguments[1] : undefined;
  var openMarker = editArea.find('#openMarker');
  var openMarkerParent = openMarker.closest('li' + ',' + blockNodeNamesString); //Bail if no open marker
...
var indentBlock = function indentBlock(paragraph, direction) {
...
var updateBlockTag = function updateBlockTag(selector) {
  ...
  var parentBlock = editArea.find('#openMarker').closest(blockNodeNamesString); //Bail if no block selected
  ...
  eligibleElements.forEach(function (el) {
    var newEl = $('<' + selectedVal + '>').html(el.html());
  ...
  replaceMarkersWithSelection(editArea); //Updated hidden input and code editor
...
var insertLinkViaUi = function insertLinkViaUi(editArea, editAreaHtml, url) {
  if ('' !== url) {
    ...
    var hiddenInput = editArea.closest('.textEditorMasterDiv').find('.textEditor').first();
