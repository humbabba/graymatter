<x-layouts.app>
    <div class="p-4 md:p-8 max-w-4xl">
        ...
        <form method="POST" action="{{ route('projects.store') }}" class="bg-graymatter-panel-light rounded-sm p-6">
            @csrf
            ...
            <div class="mb-6">
                ...
                <x-rich-editor id="content" name="content" :value="old('content', '')" />
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <a href="{{ route('projects.index') }}" class="btn bg-graymatter-panel text-text hover:bg-divider no-underline text-center">
                    Cancel
                </a>
            </div>
        </form>
