            ...
            <div class="bg-graymatter-panel-light rounded-sm overflow-hidden">
                ...
                <div class="p-8">
                    <div class="text-center mb-8">
                        <h1 class="text-graymatter-green">Set password</h1>
                        <p class="text-text-muted text-sm mt-2">Enter the code sent to your email and choose a password.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login.set-password.submit') }}">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <label for="password" class="block mb-2 font-semibold text-graymatter-teal uppercase text-sm tracking-wider" style="font-family: var(--font-display);">New password</label>
                            <input
                                type="password"
                                id="password"
                                name="password"
