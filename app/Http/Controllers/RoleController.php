...
class RoleController extends Controller
{
    ...
    {
        $permissionGroups = Permission::orderBy('name')->get()->groupBy(fn($p) => explode('.', $p->name)[0]);
        $roles = Role::all();

        return view('roles.create', compact('permissionGroups', 'roles'));
    }
    ...
    public function edit(Role $role)
    {
        ...
        return view('roles.edit', compact('role', 'permissionGroups', 'rolePermissionIds', 'roles', 'assignableRoleIds'));
    }
